...
indexcomp<- as.data.frame(matrix(data = NA, nrow = 1, ncol = 15, byrow = FALSE, dimnames = NULL))

names(indexcomp) <- c("site", "season", "SpeciesCode", "english_name", "scientific_name", "analysis_code", "sort", "BandCensuscor1", "sig1", "DETBCcor2", "sig2", "Censussig", "Bandingsig", "R2") 

write.table(indexcomp, file = paste(out.dir,"Annual Index Comparision.csv"), row.names = FALSE, append = FALSE, quote = FALSE, sep = ",")
...
write.table(indexcomp, file = paste(out.dir,"Annual Index Comparision.csv"), row.names = FALSE, col.name = FALSE, append = TRUE, quote = FALSE, sep = ",")
